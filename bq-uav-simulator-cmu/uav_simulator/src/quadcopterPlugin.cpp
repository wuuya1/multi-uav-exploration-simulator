...
void DroneSimpleController::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  std::string model_name = _model->GetName().c_str();
  //load parameters
  cmd_normal_topic_ = "/"+model_name+"/CERLAB/quadcopter/cmd_vel";
  cmd_acc_topic_ = "/"+model_name+"/CERLAB/quadcopter/cmd_acc";
  target_pose_topic_ = "/"+model_name+"/CERLAB/quadcopter/setpoint_pose";
  takeoff_topic_ = "/"+model_name+"/CERLAB/quadcopter/takeoff";
  land_topic_ = "/"+model_name+"/CERLAB/quadcopter/land";
  reset_topic_ = "/"+model_name+"/CERLAB/quadcopter/reset";
  posctrl_topic_ = "/"+model_name+"/CERLAB/quadcopter/posctrl";
  gt_pose_topic_ = "/"+model_name+"/CERLAB/quadcopter/pose";
  gt_vel_topic_ = "/"+model_name+"/CERLAB/quadcopter/vel";
  gt_acc_topic_ = "/"+model_name+"/CERLAB/quadcopter/acc";
  gt_odom_topic_ = "/"+model_name+"/CERLAB/quadcopter/odom";
  switch_mode_topic_ = "/"+model_name+"/CERLAB/quadcopter/vel_mode";
